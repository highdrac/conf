...
copy %CONF_DIR%system32\su.bat C:\windows\system32
...
del %SETTING_FILENAME%
mklink %SETTING_FILENAME% %ASR_CONF_DIR%%SETTING_FILENAME%
set SETTING_FILENAME=Script\BinEdit.txt
del %SETTING_FILENAME%
mklink %SETTING_FILENAME% %ASR_CONF_DIR%%SETTING_FILENAME%
set SETTING_FILENAME=Script\Editor.txt
del %SETTING_FILENAME%
mklink %SETTING_FILENAME% %ASR_CONF_DIR%%SETTING_FILENAME%
set SETTING_FILENAME=Script\Viewer.txt
del %SETTING_FILENAME%
mklink %SETTING_FILENAME% %ASR_CONF_DIR%%SETTING_FILENAME%
...
set TERATERM_SETTINGS_DIR=%TOOL_DIR%teraterm
set TERATERM_CONF_DIR=%CONF_DIR%teraterm\
cd %TERATERM_SETTINGS_DIR%
set SETTING_FILENAME=TERATERM.INI
del %SETTING_FILENAME%
mklink %SETTING_FILENAME% %TERATERM_CONF_DIR%%SETTING_FILENAME%
